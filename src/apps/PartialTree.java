...
public class PartialTree
{
	...
	public static class Arc implements Comparable<Arc>
	{
		...
		public boolean equals(Object o)
		{
			...
			return weight == other.weight
					&& ((v1.name.equals(other.v1.name) && v2.name
							.equals(other.v2.name)) || (v1.name
							.equals(other.v2.name) && v2.name
							.equals(other.v1.name)));
		}
		 ...
		 * @param other
		 *            Other arc
		 * @return 0 if the weights are equal, +ve if this arc's weight is
		 *         greater, -ve otherwise
		 * 
		 */
	 ...
	 * 
	 * @param vertex
	 *            Vertex used to initialize the tree
	 */
	 ...
	 * 
	 * @param other
	 *            The partial tree to be merged with this tree.
	 */
	...
	/**
	 * Returns the priority-ordered arc set of this tree. The lower the weight
	 * of an arc, the higher its priority.
	 * 
